...
Check the solution code -- were you right?
...
If you would like to adjust the bin width of your histogram to show a different level of detail, you can do so by changing the `bins` argument.
...
Does your loop look like the code from the solution block?
...
Did you take the sample in the same way that I did? Check the solution code.

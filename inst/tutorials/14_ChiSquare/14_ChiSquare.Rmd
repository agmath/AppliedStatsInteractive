...
Say that the researcher took a random sample of 1000 inmates in State Penitentiaries across the state of New Hampshire and observed the following results. In the sample, 130 inmates were white, 584 were black, 243 were hispanic, and 43 were of another race. The researcher wants to determine whether this sample of inmates refutes the notion that the state prison population in New Hampshire is reflective of the State's breakdown of population by race. We know that a new random sample of 1000 inmates would provide results different than these, so how do we determine whether we have a statistically significant result?

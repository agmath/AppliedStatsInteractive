...
question_radio(
  ...
  answer("$\\begin{array}{ll} H_0: \\text{Household income and drug use are independent of one another.} \\\\ H_a: \\text{Household income and drug use are dependent.}\\end{array}$", correct = TRUE),
  answer("$\\begin{array}{ll} H_0: \\text{Household income and drug use are dependent.} \\\\ H_a: \\text{Household income and drug use are independent of one another.}\\end{array}$"),

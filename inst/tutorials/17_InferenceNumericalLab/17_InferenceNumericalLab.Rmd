...
description: 'This lab looks at data on 1,000 pregnancies in North Carolina from 2004. This lab was also adapted from a lab written by Andrew Bray and Mine Cetinkaya-Rundel for OpenIntro.org. The notebook brings back the `inference()` function from the `{statsr}` package that was first introduced in the Topic 13 notebook. If you are working on a free-tiered Posit Cloud account, you are likely to experience crashing on relaunch of this notebook. Consider completing [this web-based version](https://agmath.github.io/OpenIntroCompanions/17_InferenceNumericalLab.html){target="_blank"} of the notebook instead. Unfortunately, hash code generation is not available for this version of the notebook.'
---

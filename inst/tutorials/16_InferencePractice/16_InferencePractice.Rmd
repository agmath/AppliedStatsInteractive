...
description: "No new content is introduced in this notebook. The notebook simply contains twelve practice problems involving inference on mean(s), inference on proportion(s), or estimating sample sizes. If you are using this notebook on a free-tiered Posit.Cloud account, stopping and restarting this notebook results in a crash due to RAM overflow. I am working on a fix. If you are on a student-tiered account, increasing your available RAM one level above the default will allow re-rendering to occur."
---
...
> **Note:** There are no hints included in this notebook. You should use the resources linked above and your previous notebooks to help you. This first three problems include links to fully worked solutions, but you'll be on your own for the remaining problems.
...
question_radio(
  "Are the observations in the two groups (temperatures is 1968 and in 2008) paired?",

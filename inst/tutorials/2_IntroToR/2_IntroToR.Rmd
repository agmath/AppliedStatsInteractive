...
Were you able to get the code to evaluate to 1?
...
Check the solution to see if you got it right!
...
Did your execution result in 69? Check the solution to see if you got it right? 
...
Click the `solution` button to see if your code matches!
